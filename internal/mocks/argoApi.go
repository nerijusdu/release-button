...
// Source: internal/api/models.go

// Package mocks is a generated GoMock package.
package mocks

import (
	api "nerijusdu/release-button/internal/api"
	reflect "reflect"
...
func (m *MockIArgoApi) GetApps(selectors map[string]string, refresh bool) (*api.Applications, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetApps", selectors, refresh)
	ret0, _ := ret[0].(*api.Applications)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
